document.addEventListener('DOMContentLoaded', () => {
    ...
    var button = document.getElementById('registration_submit_button')
    ...
    form.addEventListener('submit', event => {
        ...
        fetch(
            '/api/confirm_invite',
            {
                ...
                body: JSON.stringify(
                    {
                        email: document.getElementById('register_user_email').placeholder,
            ...
            error => {
                ...
                setTimeout(
                    () => {
                        ...
                        button.textContent = 'End invitation'
                    },
                    750
                )
            }
